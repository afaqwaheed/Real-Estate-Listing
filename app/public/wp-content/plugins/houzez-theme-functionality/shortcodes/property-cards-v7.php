...
if( !function_exists('houzez_property_card_v7') ) {
	function houzez_property_card_v7($atts, $content = null)
	{
		...
		<div id="properties_module_section" class="property-cards-module property-cards-module-v7 <?php echo esc_attr($cols_class); ?>">
	...
	add_shortcode('houzez_property_card_v7', 'houzez_property_card_v7');
}